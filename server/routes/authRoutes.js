...
const { test, getUsers, getUser, addUser, updateUser, registerUser, loginUser, addStudent, getStudents, getStudent, deleteStudent, updateStudent, 
    getProfile, updateParent, deleteUser, verifyOTP} = require('../controllers/authControllers');

const { createAssessment, getActivities, addTeacherDetails, updateTeacher, getActivity, updateActivity } = require('../controllers/actControllers');
