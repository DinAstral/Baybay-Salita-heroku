  ...
  return (
    ...
    >
      ...
      <Modal.Footer>
        ...
        <Link to={`/parentUpdateProfile/${profile}`}>
      ...
      <div className="content-body">
        ...
        <div className="content-container">
            <div className='Profile-body'>
                ...
                <h2>{user ? `${user.FirstName} ${user.LastName}` : 'Name of the Parent'}</h2>
                  <div className='profile-detail-info'>
                    <div className='profile-number'>
                    <FontAwesomeIcon icon={faAddressCard} size='1x' className="profile-icon" />
                     Contact Number: <b>{user ? `  ${user.ContactNumber}` : 'Contact'}</b>
                    </div>
            ...
            <div className='profile-nav'>
              {[
                { text: 'Basic Information', link: '/parentProfile' },
