...
const TeacherViewAssessment = ({ show, onHide, activity }) => {
  return (
    <Modal
      isOpen={show}
      onClose={onHide}
    ...
    >
      <ModalContent>
        ...
        <ModalFooter>
          ...
          <Link to={`/ViewActivityAssessment/${activity?.ActivityCode}`}>
...
TeacherViewAssessment.propTypes = {
  show: PropTypes.bool.isRequired,
  onHide: PropTypes.func.isRequired,
  activity: PropTypes.object,
};

export default TeacherViewAssessment;
