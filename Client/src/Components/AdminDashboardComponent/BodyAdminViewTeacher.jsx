        ...
        <div className="content-container">
          ...
          <div className='Profile-body'>
            ...
            <div className='profile-detail'>
              <h2>{data ? `Teacher ${data.FirstName} ${data.LastName}` : 'Name of the Teacher'}</h2>
          ...
          <div className='profile-information'>
            <div className='profile-nav'>
              {[
                { text: 'Basic Information', link: `/adminViewTeacher/${data?._id}` },
                { text: 'Education Attainment', link: `/adminViewTeacher/${data?._id}` },
              ].map((item, index) => (
