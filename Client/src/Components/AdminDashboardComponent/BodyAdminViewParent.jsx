...
const BodyAdminViewParent = () => {
  ...
  useEffect(() => {
    const menuItem = [`/adminViewParent/${data?.UserID}`];
  ...
  return (
    <div className="p-10">
      <div className="flex items-center justify-start gap-2 mb-5 ">
        <h1 className="text-3xl font-semibold">View Parent Profile</h1>
        <Tooltip
          showArrow={true}
          content={
            <div className="p-2">
              ...
              <div className="text-xs">
                This function will view the parent's information in the system.
              </div>
            </div>
          }
        >
